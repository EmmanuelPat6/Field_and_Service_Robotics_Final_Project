%% UAV Obstacle Avoidance with Hierarchical Control and APF
...
out = sim("hierarchical_control.slx");
...
exportgraphics(plot_1, 'Position_x_y_z_Errors_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_2, 'Velocity_x_y_z_Errors_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_3, 'uT_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_4, 'tau_b_x_y_z_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_5, 'Desired_Position_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_6, 'Desired_Velocity_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_11, 'Desired_Attitude_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_12, 'Desired_Attitude_Velocity_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_7, 'F_att_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_8, 'F_rep_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle', [0 0 1 1], 'Color', 'w');
exportgraphics(plot_9, 'eta_Errors_Hierarchical_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle', [0 0 1 1], 'Color', 'w');
exportgraphics(plot_10, 'eta_dot_Errors_Hierarchical_APF.pdf');
