%% UAV Obstacle Avoidance with Passivity-Based Control and APF
...
% New Initial Condition for the RPY UAV Dynamics Model
eta_b_0 = [0 0 0];
eta_b_dot_0 = [0 0 0];
...
out = sim("passivity_based_control.slx");
...
plot(out.err_p.Time, err_p_x, '-', 'LineWidth', 2.5)
hold on
plot(out.err_p.Time, err_p_y, '-', 'Color', [0.9, 0, 0], 'LineWidth', 2.5)
plot(out.err_p.Time, err_p_z, '-', 'Color', [0.9, 0.7, 0.15], 'LineWidth', 2.5)
...
ylim([ ...
    min([err_p_x, err_p_y, err_p_z]), ...
    max([err_p_x, err_p_y, err_p_z]) ...
]);
...
exportgraphics(plot_1, 'Position_x_y_z_Errors_Passivity_Based_Control_APF.pdf');


err_p_dot = squeeze(out.err_p_dot.Data);
err_p_dot_x = err_p_dot(1, :);
err_p_dot_y = err_p_dot(2, :);
err_p_dot_z = err_p_dot(3, :);

plot_2 = figure('Name', 'Velocity x, y, z Errors', 'Position', [10 10 900 350]);
plot(out.err_p_dot.Time,err_p_dot_x,'-', 'LineWidth', 2.5)
hold on
plot(out.err_p_dot.Time,err_p_dot_y,'-','Color', [0.9, 0, 0], 'LineWidth', 2.5)
plot(out.err_p_dot.Time,err_p_dot_z,'-','Color', [0.9, 0.7, 0.15], 'LineWidth', 2.5)
xlabel('$t [s]$', 'Interpreter', 'latex', 'FontSize', 26)
ylabel('$e [m/s]$', 'Interpreter', 'latex', 'FontSize', 26)
set(gca, 'FontSize', 26);
grid on
box on
xlim([0, out.err_p_dot.Time(end)])
ylim([min([err_p_dot_x, err_p_dot_y, err_p_dot_z]), ...
      max([err_p_dot_x, err_p_dot_y, err_p_dot_z])])
legend({'$e_{\dot{p}_x}(t)$', '$e_{\dot{p}_y}(t)$', '$e_{\dot{p}_z}(t)$'}, 'Interpreter', 'latex', 'Location', 'eastoutside','FontSize', 30)
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_2, 'Velocity_x_y_z_Errors_Passivity_Based_Control_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_3, 'uT_Passivity_Based_Control_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_4, 'tau_b_x_y_z_Passivity_Based_Control_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_5, 'Desired_Position_Passivity_Based_Control_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_6, 'Desired_Velocity_Passivity_Based_Control_APF.pdf');



plot_11 = figure('Name', 'Desired Attitude', 'Position', [10 10 900 350]);
plot(out.eta_b_des.Time,out.eta_b_des.Data(:,1),'-', 'LineWidth', 2.5)
hold on
plot(out.eta_b_des.Time,out.eta_b_des.Data(:,2),'-','Color', [0.9, 0, 0], 'LineWidth', 2.5)
plot(out.eta_b_des.Time,out.eta_b_des.Data(:,3),'Color', [0.9, 0.7, 0.15], 'LineWidth', 2.5)
xlabel('$t [s]$', 'Interpreter', 'latex', 'FontSize', 26)
ylabel('$\eta_d [rad]$', 'Interpreter', 'latex', 'FontSize', 26)
set(gca, 'FontSize', 26);
grid on
box on
xlim([0, out.eta_b_des.Time(end)])
ylim([min([out.eta_b_des.Data(:,1); out.eta_b_des.Data(:,2); out.eta_b_des.Data(:,3)]), ...
      max([out.eta_b_des.Data(:,1); out.eta_b_des.Data(:,2); out.eta_b_des.Data(:,3)])])
legend({'$\eta_{d_1}(t)$', '$\eta_{d_2}(t)$', '$\eta_{d_3}(t)$'}, 'Interpreter', 'latex', 'Location', 'eastoutside','FontSize', 30)
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_11, 'Desired_Attitude_Passivity_Based_Control_APF.pdf');


plot_12 = figure('Name', 'Desired Attitude Velocity', 'Position', [10 10 900 350]);
plot(out.eta_b_dot_des.Time,out.eta_b_dot_des.Data(:,1),'-', 'LineWidth', 2.5)
hold on
plot(out.eta_b_dot_des.Time,out.eta_b_dot_des.Data(:,2),'-','Color', [0.9, 0, 0], 'LineWidth', 2.5)
plot(out.eta_b_dot_des.Time,out.eta_b_dot_des.Data(:,3),'Color', [0.9, 0.7, 0.15], 'LineWidth', 2.5)
xlabel('$t [s]$', 'Interpreter', 'latex', 'FontSize', 26)
ylabel('$\dot{\eta}_d [rad/s]$', 'Interpreter', 'latex', 'FontSize', 26)
set(gca, 'FontSize', 26);
grid on
box on
xlim([0, out.eta_b_dot_des.Time(end)])
ylim([min([out.eta_b_dot_des.Data(:,1); out.eta_b_dot_des.Data(:,2); out.eta_b_dot_des.Data(:,3)]), ...
      max([out.eta_b_dot_des.Data(:,1); out.eta_b_dot_des.Data(:,2); out.eta_b_dot_des.Data(:,3)])])
legend({'$\dot{\eta}_{d_1}(t)$', '$\dot{\eta}_{d_2}(t)$', '$\dot{\eta}_{d_3}(t)$'}, 'Interpreter', 'latex', 'Location', 'eastoutside','FontSize', 30)
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_12, 'Desired_Attitude_Velocity_Passivity_Based_Control_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_7, 'F_att_Passivity_Based_Control_APF.pdf');
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_8, 'F_rep_Passivity_Based_Control_APF.pdf');


%% Attitude Errors
err_eta = squeeze(out.err_eta.Data);
err_eta_1 = err_eta(1, :);
err_eta_2 = err_eta(2, :);
err_eta_3 = err_eta(3, :);

plot_9 = figure('Name', 'Attitude Error', 'Position', [10 10 900 350]);
plot(out.err_eta.Time, err_eta_1, '-', 'LineWidth', 2.5)
hold on
plot(out.err_eta.Time, err_eta_2, '-', 'Color', [0.9, 0, 0], 'LineWidth', 2.5)
plot(out.err_eta.Time, err_eta_3, '-', 'Color', [0.9, 0.7, 0.15], 'LineWidth', 2.5)
xlabel('$t\ [s]$', 'Interpreter', 'latex', 'FontSize', 26)
ylabel('$e\ [rad]$', 'Interpreter', 'latex', 'FontSize', 26)
set(gca, 'FontSize', 26);
grid on
box on
xlim([0, out.err_eta.Time(end)])
ylim([ ...
    min([err_eta_1, err_eta_2, err_eta_3]), ...
    max([err_eta_1, err_eta_2, err_eta_3]) ...
]);
legend({'$e_{\eta_1}(t)$', '$e_{\eta_2}(t)$', '$e_{\eta_3}(t)$'}, ...
    'Interpreter', 'latex', 'Location', 'eastoutside', 'FontSize', 30)
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle', [0 0 1 1], 'Color', 'w');
exportgraphics(plot_9, 'eta_Errors_Passivity_Based_Control_APF.pdf');



err_eta_dot = squeeze(out.err_eta_dot.Data);
err_eta_1_dot = err_eta_dot(1, :);
err_eta_2_dot = err_eta_dot(2, :);
err_eta_3_dot = err_eta_dot(3, :);

plot_10 = figure('Name', 'Attitude Velocity Error', 'Position', [10 10 900 350]);
plot(out.err_eta_dot.Time, err_eta_1_dot, '-', 'LineWidth', 2.5)
hold on
plot(out.err_eta_dot.Time, err_eta_2_dot, '-', 'Color', [0.9, 0, 0], 'LineWidth', 2.5)
plot(out.err_eta_dot.Time, err_eta_3_dot, '-', 'Color', [0.9, 0.7, 0.15], 'LineWidth', 2.5)
xlabel('$t\ [s]$', 'Interpreter', 'latex', 'FontSize', 26)
ylabel('$e\ [rad/s]$', 'Interpreter', 'latex', 'FontSize', 26)
set(gca, 'FontSize', 26);
grid on
box on
xlim([0, out.err_eta_dot.Time(end)])
ylim([ ...
    min([err_eta_1_dot, err_eta_2_dot, err_eta_3_dot]), ...
    max([err_eta_1_dot, err_eta_2_dot, err_eta_3_dot]) ...
]);
legend({'$e_{\dot{\eta}_1}(t)$', '$e_{\dot{\eta}_2}(t)$', '$e_{\dot{\eta}_3}(t)$'}, ...
    'Interpreter', 'latex', 'Location', 'eastoutside', 'FontSize', 30)
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle', [0 0 1 1], 'Color', 'w');
exportgraphics(plot_10, 'eta_dot_Errors_Passivity_Based_Control_APF.pdf');
...
plot_11 = figure('Name', 'f_x_hat and disturbance', 'Position', [10 10 900 350]);
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_11, 'f_hat_x_and_disturbace.pdf');

plot_12 = figure('Name', 'f_y_hat and disturbance', 'Position', [10 10 900 350]);
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_12, 'f_hat_y_and_disturbace.pdf');

plot_13 = figure('Name', 'f_z_hat', 'Position', [10 10 900 350]);
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_13, 'f_hat_z_and_disturbance.pdf');

% plot_14 = figure('Name', 'tau_x_hat', 'Position', [10 10 900 350]);
...
% set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
% annotation('rectangle',[0 0 1 1],'Color','w');
% exportgraphics(plot_14, 'tau_hat_x.pdf');
% 
% plot_15 = figure('Name', 'tau_y_hat', 'Position', [10 10 900 350]);
...
% set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
% annotation('rectangle',[0 0 1 1],'Color','w');
% exportgraphics(plot_15, 'tau_hat_y.pdf');

plot_16 = figure('Name', 'tau_z_hat and disturbance', 'Position', [10 10 900 350]);
...
set(gca, 'InnerPosition', [0.1400 0.32 0.82 0.55])
annotation('rectangle',[0 0 1 1],'Color','w');
exportgraphics(plot_16, 'tau_hat_z_and_disturbance.pdf');
